...
public class FullscreenEffectRenderGraph : FullscreenEffectBaseRenderGraph<FullscreenPassBase<FullscreenPassDataBase>>
{
}

[ExecuteAlways]
public class FullscreenEffectBaseRenderGraph<T> : MonoBehaviour where T : FullscreenPassBase<FullscreenPassDataBase>, new()
{
    private T _pass;
